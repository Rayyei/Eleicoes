...
int main()
{
  ...
  //SOMA DOS VOTOS
  {
    ...
    if((cand2 > cand1)&&(cand2 > cand3)&&(cand2>cand4)&&(cand2 > branco)&&(cand2 > nulo)){
      printf("\n*CANDIDATO 2 VENCEU!*");
    }
    if((cand3 > cand1)&&(cand3>cand2)&&(cand3 > cand4)&&(cand3 > branco)&&(cand3 > nulo)){
      printf("\n*CANDIDATO 3 VENCEU!*");
    }
    if((cand4 > cand1)&&(cand4 > cand2)&&(cand4>cand3)&&(cand4 > branco)&&(cand4 > nulo)){
      printf("\n*CANDIDATO 4 VENCEU!*");
    }
    if((branco > cand1)&&(branco > cand2)&&(branco > cand3) && (branco > cand4)&&(branco>nulo)){
      printf("\n*VOTOS EM BRANCO VENCEU!*");
    }
    if((nulo > cand1)&&(nulo > cand2)&&(nulo>cand3)&&(nulo > cand4)&&(nulo>branco)){
      printf("\n*VOTOS EM NULO VENCEU*");
    }  
    else if ((cand1 == cand2)||(cand1 == cand3)||(cand1 == cand4)||(cand1 == nulo)||(cand1 == branco)){
      printf("\n*EMPATE*");
    }
  }
     return 0;
